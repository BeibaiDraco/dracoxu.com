...
export const projects = [
  {
    ...
    plate: 'tree',
    panels: ['AI for Science', 'Artificial Intelligence'],
  ...
  },
  {
    ...
    plate: 'graph',
    panels: ['Computational Neuroscience', 'Artificial Intelligence'],
  ...
  },
  {
    ...
    plate: 'rotation',
    panels: ['Computational Neuroscience', 'Philosophy of Perception'],
